...
def printTag(jobdata):
    ...
    f.write("\n")
    f.write('A680,40,2,1,1,1,N,"M. Charge:"')
    f.write("\n")
    
    f.write("\n")
    f.write("A575,40,2,1,1,1,N,")
    f.write('"'+data['lc']+'"')
    f.write("\n")
    f.write('A525,40,2,1,1,1,N,"X"')
    f.write("\n")
    
    f.write('A505,40,2,1,1,1,N,')
    f.write('"'+data['pieces']+'"')
    f.write("\n")

    f.write('A490,40,2,1,1,1,N,"="')
    f.write("\n")
