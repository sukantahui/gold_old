...
def createTag(jobDetails,customer,rawMaterials,setTagOption):
        ...
        filedata_0f+= "A395,85,2,1,1,1,N,'PJ'\n"
        filedata_0f+= "A245,85,2,1,1,1,N,'Of'\n"
        filedata_0f+= "B405,70,2,1,2,1,33,N,'2750'\n"
        filedata_0f+= "A405,33,2,2,1,1,N,'BB'\n"
        filedata_0f+= "A245,33,2,2,1,1,N,'2750'\n"
        filedata_0f+= "A680,80,2,1,1,1,N,'C0277-H'\n"
        filedata_0f+= "A602,80,2,1,1,1,N,'Size:'\n"
        filedata_0f+= "A549,80,2,1,1,1,N,'2-3-0'\n"
        filedata_0f+= "A490,80,2,1,1,1,N,'Qty:'\n"
        filedata_0f+= "A450,80,2,1,1,1,N,'2'\n"
        filedata_0f+= "A680,60,2,1,1,1,N,'Gold Weight:'\n"
        filedata_0f+= "A550,60,2,1,1,1,N,'" + str(fineGold) + "'\n"
        ...
        filedata_0f+= "A600,20,2,1,1,1,N,'1260'\n"
        filedata_0f+= "A555,20,2,1,1,1,N,'X'\n"
        filedata_0f+= "A535,20,2,1,1,1,N,'2'\n"
        filedata_0f+= "A515,20,2,1,1,1,N,'='\n"
        filedata_0f+= "A505,20,2,1,1,1,N,'2520'\n"
        filedata_0f+= "P1\n\n"
        ...
        filedata_100f+= "A395,85,2,1,1,1,N,'PJ'\n"
        filedata_100f+= "A245,85,2,1,1,1,N,'Of'\n"
        filedata_100f+= "B405,70,2,1,2,1,33,N,'2750'\n"
        filedata_100f+= "A405,33,2,2,1,1,N,'BB'\n"
        filedata_100f+= "A245,33,2,2,1,1,N,'2750'\n"
        filedata_100f+= "A680,80,2,1,1,1,N,'C0277-H'\n"
        filedata_100f+= "A602,80,2,1,1,1,N,'Size:'\n"
        filedata_100f+= "A549,80,2,1,1,1,N,'2-3-0'\n"
        filedata_100f+= "A490,80,2,1,1,1,N,'Qty:'\n"
        filedata_100f+= "A450,80,2,1,1,1,N,'2'\n"
        filedata_100f+= "A680,60,2,1,1,1,N,'Gold Weight:'\n"
        filedata_100f+= "A550,60,2,1,1,1,N,'" + str(fineGold) + "'\n"
        ...
        filedata_100f+= "A600,20,2,1,1,1,N,'1260'\n"
        filedata_100f+= "A555,20,2,1,1,1,N,'X'\n"
        filedata_100f+= "A535,20,2,1,1,1,N,'2'\n"
        filedata_100f+= "A515,20,2,1,1,1,N,'='\n"
        filedata_100f+= "A505,20,2,1,1,1,N,'2520'\n"
        filedata_100f+= "P1\n\n"
        ...
        filedata_200f+= "A395,85,2,1,1,1,N,'PJ'\n"
        filedata_200f+= "A245,85,2,1,1,1,N,'Of'\n"
        filedata_200f+= "B405,70,2,1,2,1,33,N,'2750'\n"
        filedata_200f+= "A405,33,2,2,1,1,N,'BB'\n"
        filedata_200f+= "A245,33,2,2,1,1,N,'2750'\n"
        filedata_200f+= "A680,80,2,1,1,1,N,'C0277-H'\n"
        filedata_200f+= "A602,80,2,1,1,1,N,'Size:'\n"
        filedata_200f+= "A549,80,2,1,1,1,N,'2-3-0'\n"
        filedata_200f+= "A490,80,2,1,1,1,N,'Qty:'\n"
        filedata_200f+= "A450,80,2,1,1,1,N,'2'\n"
        filedata_200f+= "A680,60,2,1,1,1,N,'Gold Weight:'\n"
        filedata_200f+= "A550,60,2,1,1,1,N,'" + str(fineGold) + "'\n"
        ...
        filedata_200f+= "A600,20,2,1,1,1,N,'1260'\n"
        filedata_200f+= "A555,20,2,1,1,1,N,'X'\n"
        filedata_200f+= "A535,20,2,1,1,1,N,'2'\n"
        filedata_200f+= "A515,20,2,1,1,1,N,'='\n"
        filedata_200f+= "A505,20,2,1,1,1,N,'2520'\n"
        filedata_200f+= "P1\n"
